...
mixer.init()
mixer.music.load("bc song.ogg")
mixer.music.set_volume(0.02)
mixer.music.play()

kick = mixer.Sound("kick.ogg")
finish_him = mixer.Sound("finish_him.ogg")
iamblue = mixer.Sound("blue.ogg")
iamblue.set_volume(0.08)
leddyred = mixer.Sound("red.ogg")
leddyred.set_volume(0.08)
...
clock = time.Clock()
background = transform.scale(image.load("new bc.png"),(mw_w,mw_h))
blue = transform.scale(image.load("blue.png"),(mw_w,mw_h))
red = transform.scale(image.load("red.png"),(mw_w,mw_h))
platform_l = Platform("platform.png",10,mw_h/2,40,200,5)
platform_r = Platform("platform.png",mw_w - 50,mw_h/2,40,200,5)
ball = Ball("basketball ball.png",start_x,start_y,80,80,start_speed,5)
wall_u = GameObject("walls.png",0,0,mw_w,20,0)
wall_d = GameObject("walls.png",0,mw_h-20,mw_w,20,0)
